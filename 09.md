...
这实际上是一个为期9周的课程,所以对于一些团体来说,这是有点困难的,因为我们在课程开始的时候有一些小问题。事情是这样的。九个更新中有八个是可以的。但我们也要延长课程的时间,实际上是在讲座结束后两周,这样如果你愿意的话,就有足够的时间进行10次更新,你选择了10次中的9次,但9次中的8次将是10,000美元的绝对需要考虑的条件。我们会很灵活,但让他们做好的更新,使他们真正的更新。又一次提醒。每周更新的时间是晚上11点59分。每周日太平洋标准时间。这方面有些混乱,我们已经写了很多次了,但请回忆一下是什么时候写的。再次,关于任何问题,关于您的主持人,关于您的小组,关于您的更新,请发送到创业学校在联合网站。我最后的笔记是一个提醒,如果你还没有启动。找出你是否做了人们真正想要的东西的唯一方法是让人们真正使用它,所以如果你没有,那么就把你的产品拿出来。现在,我要向大家介绍我们的第一位演讲者,他是Y Combinator公司尊敬的合伙人Gustaf Alstr mer,他在2012年加入了Airbnb的增长团队。
...
对乘车提供补贴或奖励如何?好吧,我认为激励措施是超级可扩展的。就像Airbnb一样,我们还有转诊计划。他们注册了,我不知道几乎每天都有成千上万的用户,他们中的很大一部分是通过推荐注册的,所以这是一个补贴实际上是可扩展的例子。现在,我给你一张优惠券不是可扩展的,但是通过电子邮件系统-通过Whatapp、Messenger或其他渠道-实际上是可扩展的,只要你不亏钱。你必须对你发放的钱有一个非常好的ROI计算,并且知道这是增量的钱,如果你不给钱,那些用户就不会真正开始使用你的产品。所以只要你有一个好的处理,这是完全好的。是
